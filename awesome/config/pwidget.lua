...
awful.popup {
  ...
  border_color = '#1A1B26',
  border_width = 5,
  placement    = function(c) awful.placement.bottom_right(c, { margins = dpi(7) }) end,
...
awful.popup {
  ...
  --border_color = '#1A1B26',
  border_width = 0,
  placement    = function(c) awful.placement.top_left(c, { margins = {left = dpi(20),top = dpi(20) } }) end,
  shape        = gears.shape.rounded_rect,
  visible      = true,
}
...
awful.popup {
  ...
  border_color = '#1A1B26',
  border_width = 5,
  placement    = function(c) awful.placement.bottom_right(c, { margins = {right = dpi(250),bottom = dpi(7) } }) end,
  shape        = gears.shape.rounded_rect,
  visible      = true,
}
...
awful.popup {
  ...
  border_color = '#1A1B26',
  border_width = 5,
  placement    = function(c) awful.placement.bottom_right(c, { margins = {right = dpi(500),bottom = dpi(7) } }) end,
  shape        = gears.shape.rounded_rect,
  visible      = true,
}
