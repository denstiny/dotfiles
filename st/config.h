 ...
 */
// static char *font = "FiraCode Nerd
// Font:pixelsize=22:antialias=true:autohint=true";

static char *fonts[] = {
    "Fira Code Nerd Font Mono:pixelsize=19:antialias=false:autohint=true",
    "BlexMono Nerd Font Mono:pixelsize=19:antialias=true:autohint=false",
};
...
static char *openurlcmd[] = {
    ...
    "/^www./http:\\/\\/www\\./g' | dmenu -i -p 'Follow which url?' -l 10 | xa"
    "rgs -r xdg-open",
    "externalpipe", NULL};
static char *copyurlcmd[] = {
    ...
    "((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./&%"
    "?#=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)' | uniq | sed 's"
    "/^www./http:\\/\\/www\\./g' | dmenu -i -p 'Copy which url?' -l 10 | tr -d"
